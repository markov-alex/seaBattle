class BattlefieldView extends Battlefield {
    // html блок, соответствующий игровому полю
    root = null;
    // html таблица, входящая в root и содержащая ячейки поля
    table = null;
    // html блок, входящий в root и изначально содержащий корабли
    dock = null;
    // html блок, входящий в root
    polygon = null;
    ...
    constructor() {
        ...
        for (let x = 0; x < 10; ++x) {
            ...
            marker.textContent = 'AБВГДЕЖЗИК'[x];
            cell.append(marker);
        }
